...
public class GUIManager extends JFrame {
   ...
   private final HotelController controllerListener;
    ...
    private JPanel createMakeBooking(){
        ...
        makeBookingPanel.add(new JLabel("Make Booking"));
        
        JButton menuButton = new JButton("Menu");
        menuButton.setActionCommand("Menu");
        menuButton.addActionListener(controllerListener);
        addComponent(makeBookingPanel, menuButton, 0,0);
        ...
        addComponent(makeBookingPanel, submitButton, 3,5);
    ...
    public void switchToSearchBooking(HashSet<Room> allRooms){
        ...
        if (rooms.getItemCount() > 0) rooms.setSelectedIndex(0);
    ...
    public void switchToEditBooking(Booking booking, HashSet<Room> availableRooms){
        ...
        addComponent(editBookingPanel,name,1,1);
        addComponent(editBookingPanel,email,2,1);
        addComponent(editBookingPanel,phoneNumber,3,1);
        addComponent(editBookingPanel,warningMessages,0,5);
        addComponent(editBookingPanel,rooms,4,3);
        addComponent(editBookingPanel,startDay,1,2);
        addComponent(editBookingPanel,startMonth,2,2);
        addComponent(editBookingPanel,startYear,3,2);
        addComponent(editBookingPanel,endDay,1,3);
        addComponent(editBookingPanel,endMonth,2,3);
        addComponent(editBookingPanel,endYear,3,3);
    ...
    public void showBookingsFound(HashSet<Booking> bookingsFound){
        ...
        if (bookings.getItemCount() > 0) rooms.setSelectedIndex(0);
